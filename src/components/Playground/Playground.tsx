  ...
  const reqHeadersEl = fields.map((item, index) => {
    return (
      <div className="req-header" key={item.id}>
        ...
        <button className="btn-del" onClick={() => remove(index)}>
          X
        </button>
      </div>
    );
    ...
    <main className="playground">
      ...
      <form className="editor-viewer" onSubmit={handleSubmit(onSubmit)}>
        <div className="buttons">
          ...
          <button className={isDocVisible ? 'btn-pushed' : ''} onClick={getDoc}>
            {useLocale.doc}
          </button>
        ...
        <div className="editor">
          <div className="input-endpoint">
            <label className="input-title" htmlFor="endpoint">
              {useLocale.endpoint}
            </label>
            <input
              id="endpoint"
          ...
          <div className="req-headers-wrapper">
            <div className="req-headers-title">
              ...
              <button className="btn-small" onClick={showReqHeaders}>
                {isReqHeadersVisible ? useLocale.hide : useLocale.show}
              </button>
              <button
                className={`btn-small ${isReqHeadersVisible ? '' : 'hidden'}`}
            ...
            <div
              className={`req-headers ${isReqHeadersVisible ? '' : 'hidden'}`}
              {...register('reqHeaders')}
            >
              {reqHeadersEl}
            </div>
          ...
          <div className="variables-title">
            ...
            <button className="btn-small" onClick={showVariables}>
              {isVariablesVisible ? useLocale.hide : useLocale.show}
            </button>
          </div>
          <textarea
